        ...
        <div class="container">
            <div class="row align-items-end">
                <div class="col-lg-12 text-center">
                    <h2 class="mb-0 font-weight-bold ">اختبارات الصف الثالث </h2>
                    <p>2020/2021</p>
                </div>
            </div>
        </div>
    ...
    <div class="site-section">
        <div class="container">
            <div class="row">
                <div class="col-lg-4 mt-2" >
                    <div class="course-1-item" style="border: solid #0b0b0b 1px ; border-radius: 10px ">
                        <figure class="thumnail">
                            ...
                            <div class="category text-center" ><h3>الاختبار الاول </h3></div>
                        </figure>
                        <div class="course-1-content pb-4">
                            <h2>شامل (الوحدة الاولي - الوحدة الثانية)</h2>

                            <p class="desc mb-4">درجة الاختبار 30 درجة </p>
                            <p class="desc mb-4 table-primary font-weight-bold form-control-lg">هذا الاختبار متاح بشكل مجاني </p>
                            <form method="get" action="free_test_for_3.php">
                                <button name="id" id="id" class="col-lg-6 btn btn-primary   float-right mt-2" value="1">الدخول للاختبار </button>

                            </form>
                            <form method="get" action="view_last_answer_3.php">
                                <button name="id" id="id" class=" col-lg-6 btn btn-warning mt-2" value="1"> اجابتك السابقة</button>
                            </form>
                ...
                <?php
                $posts=mysqli_query( $connect ,"SELECT * FROM add_test_data where `level`='3'");
                ...
                <div class="col-lg-4 mt-2" >
                    <div class="course-1-item" style="border: solid #0b0b0b 1px ; border-radius: 10px ">
                        ...
                        <div class="course-1-content pb-4">s
                            <h2>'.$post['test_1_content'].'</h2>
                            
                            <p class="desc mb-4">'.$post['test_1_time'].'</p>
                            <form method="get" action="test_3.php">
