...
if (isset($_POST['answer'])){
    ...
    $msg='<div class="alert alert-success mb-5" role="alert"> تم ارسال اجابتك  </div>';
    session_write_close();
    echo'<meta http-equiv="refresh" content="1;\'show_answer_free_test_3.php?id='.$test_num.'\'"/>';
...
<form dir="rtl" align="right" method="post" class="mr-4">
<!--بداية السوال الاول -->
